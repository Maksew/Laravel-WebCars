<section class="space-y-6">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                <x-input-label for="password" value="{{ __('Mot de passe') }}" class="sr-only"></x-input-label>
                ...
                <x-text-input
                    ...
                    placeholder="{{ __('Mot de passe') }}"></x-text-input>

                <x-input-error :messages="$errors->userDeletion->get('password')" class="mt-2"></x-input-error>
            </div>
