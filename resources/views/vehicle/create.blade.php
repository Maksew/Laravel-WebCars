                ...
                <form action="{{ route('store.vehicle') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="range" id="year" name="year" class="form-control" min="1900" max="2023" value="2023" oninput="yearOutput.value = year.value">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <input type="range" id="kilometrage" name="kilometrage" class="form-control-range" min="0" max="999999" value="0" oninput="syncValues()">
                                <input type="number" id="kilometrageInput" name="kilometrageInput" class="form-control" min="0" max="999999" value="0" oninput="syncValues()">
                            </div>
